...
train=pd.read_csv('C:/Users/hp/Desktop/datasets/walmart_train.csv')
test=pd.read_csv('C:/Users/hp/Desktop/datasets/walmart_test.csv')
...
print(f'Mean Squared Error = {np.mean((LinReg.predict(X_test)-Y_test)**2)}' + f'\nVariance Score = {LinReg.score(X_test,Y_test)}')
